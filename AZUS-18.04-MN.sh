...
wget https://github.com/AzusNodes/AZUS-MultiMN/releases/download/v1.0.0/azus-1.0.0-Ubuntu18.04-daemon.tar.gz
tar -xzvf azus-1.0.0-Ubuntu18.04-daemon.tar.gz
