#!/bin/bash
# AZUS Masternode Setup Script V1.0.0 for Ubuntu LTS
#
...
echo -e "${GREEN} ------- AZUS MASTERNODE INSTALLER V1.0.0--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/AzusNodes/AZUS-MultiMN/releases/download/v1.0.0/azus-1.0.0-Ubuntu20.04-daemon.tar.gz
tar -xzvf azus-1.0.0-Ubuntu20.04-daemon.tar.gz
...
cd ~/.azus && wget https://github.com/AzusNodes/AZUS-MultiMN/releases/download/v1.0.0/bootstrap.zip
...
into your ${GREEN}masternode.conf${NC} file and replace:
    ${GREEN}AZUS_mn1${NC} - with your desired masternode name (alias)
